...
import com.owner.entity.req.ImageMessage;
import com.owner.entity.resp.TextMessage;
...
public class CoreService {  
    ...
    public static String processRequest(HttpServletRequest request) {  
        ...
        try {  
            ...
            im.setPicUrl(GirlsPictureService.downloadUrlToStream(new Random().nextInt(999)+1));
            // 回复文本消息  
